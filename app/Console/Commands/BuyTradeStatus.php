...
class BuyTradeStatus extends Command
{
    ...
    public function handle()
    {
        ...
        if(count($liq_pairs) > 0){
            foreach ($liq_pairs as $pair) {
                $buytrades = Buytrade::where([ ['status', '=', 0],['pair', '=', $pair->id]])->get();
                    ...
                    foreach ($buytrades as $buytrade) {
                        ...
                        elseif($orderstatus['status'] == "FILLED"){
                          ...
                          $adminbalanceupdate = $this->adminBalanceUpdate($pair->cointwo, $buytrade->fees,'buy');
                            AdminTransactions::CreateTransaction($buytrade->uid, 'buy', $pair->cointwo,0,$buytrade->price,$buytrade->volume,$buytrade->value,$buytrade->fees,$buytrade->commission,'Buy trade complete');
                            ...
                            $remark ="Buy trade complete bittrex pair $pair->coinone /$pair->cointwo";
    ...
    */
    public function creditAmount($uid, $currency, $price,$remark=null,$actionfrom=null,$actionid=null) {
        ...
        OverallTransaction::addTransaction($uid,$currency,'buytrade',$price,0,$balance,$oldbalance,$remark,$actionfrom,$actionid);
    }
    /**
