...
<tr><td align='center'>&nbsp;</td><td align='center'><a href="<?php echo  $actionUrl ;?>" style='color:#000;padding:14px 22px;text-decoration:none;background-color:#23005e;text-transform:uppercase;font-size:15px;font-weight:600;'>Reset Password</a></td><td align='center'>&nbsp;</td></tr>
